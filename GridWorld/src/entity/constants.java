...
public class constants {
    ...
    // Constant c
    public static final double C = 0.100;	//constant parameter to adjust the maximum error allowed
    // Epsilon e = c * Rmax
    public static final double EPSILON = C * R_MAX;

    public static final double UTILITY_UPPER_BOUND = R_MAX / (1 - DISCOUNT);

    public static final double CONVERGENCE_THRESHOLD = EPSILON * ((1.000 - DISCOUNT) / DISCOUNT);
